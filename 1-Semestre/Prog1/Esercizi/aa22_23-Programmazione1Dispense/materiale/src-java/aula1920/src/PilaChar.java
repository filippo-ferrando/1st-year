 ...
 * di sequenze di caratteri in accordo con la poitica LIFO.
 * <p>
...
public class PilaChar {
	...
	private static void espande() {
		...
		char[] tmp = new char[stack.length + COSTANTE_DI_ESPANSIONE];
	...
	public static void reset() {
		stack = new char[1]; // singola cella pronta per l'uso
		top = 0;
	}
